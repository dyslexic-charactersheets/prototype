...
CharacterSheets.registerFieldControl('input', {
    defaults: {
        value: '',
        border: 'bottom',
    }, 
...
CharacterSheets.registerFieldControl('speed', {
    defaults: {
        units: "imperial",
        value: '',
        width: 'large',
...
CharacterSheets.registerFieldControl('weight', {
    defaults: {
        schema: "starfinder",
    }, 
    render: args => {
...
CharacterSheets.registerFieldControl('radio', {
    defaults: {
        checked: false,
        border: 'none',
    }, 
...
CharacterSheets.registerFieldControl('checkbox', {
    defaults: {
        checked: false,
        border: 'none',
    }, 
...
CharacterSheets.registerFieldControl('boost', {
    defaults: {
        checked: false,
        up: true,
        down: true,
...
CharacterSheets.registerFieldControl('checkgrid', {
    defaults: {
        checked: false,
        border: 'none',
        max: 10,
...
CharacterSheets.registerFieldControl('alignment', {
    defaults: {
        value: '',
        border: 'none',
    }, 
...
CharacterSheets.registerFieldControl('proficiency', {
    defaults: {
        value: 0,
        icon: true,
    },
...
CharacterSheets.registerFieldControl('proficiency-icon', {
    render: args => {
...
CharacterSheets.registerFieldControl('money', {
    defaults: {
        indent: 0,
        digits: 3,
        shift: 0,
...
CharacterSheets.registerFieldControl('compound', {
    defaults: {
        parts: [],
    }, 
...
CharacterSheets.registerFieldControl('progression', {
    defaults: {
        parts: [],
        border: "none",
    }, 
