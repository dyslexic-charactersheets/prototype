...
CharacterSheets.register('field', 'id', {
    frame: 'normal',
    control: 'input',
    value: '',
    repeat: 1,
    ...
    var cls = elementClass('field', null, args, [ "output", "icon", "bold", "unlined", "attack", "ref", "misc", "temp", "merge-bottom" ], [ "frame", "control", "align", "size", "width", "icon", "proficiency", "labelHeight", "digits", "shift" ]);
